...
class Encoder_z0_ODE_RNN(nn.Module):
	...
	def run_odernn(self, data, time_steps, 
		...
		for i in time_points_iter:
			# z0_diffeq_solver is using "euler", whose step size is fixed.
			# If (prev_t - t_i) is too small, simply calling ode_func once instead of calling ode solver is enough.
